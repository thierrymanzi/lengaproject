...
from dashboard.utils.summarised.completion.completion_handler import BaseCompletionHandler
...
class CompletionStatsView(generics.ListAPIView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        baseCompletionStats = BaseCompletionHandler(
                request, users,
            month_or_week,
            partner,
